...
function parseTarget(target) {
    var _a, _b, _c, _d;
    const match = (_c = (_b = (_a = IPV4_REGEX.exec(target), (_a !== null && _a !== void 0 ? _a : IPV6_REGEX.exec(target))), (_b !== null && _b !== void 0 ? _b : IPV6_BRACKET_REGEX.exec(target))), (_c !== null && _c !== void 0 ? _c : DNS_REGEX.exec(target)));
    if (match) {
        return {
            host: match[1],
            port: (_d = match[2], (_d !== null && _d !== void 0 ? _d : undefined))
        };
    }
    else {
        return null;
